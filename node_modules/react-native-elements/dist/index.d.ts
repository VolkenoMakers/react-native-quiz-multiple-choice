...
declare const AirbnbRating: import("react").FunctionComponent<Omit<AirbnbRatingProps, keyof import("./config/ThemeProvider").ThemeProps<T>>> | import("react").ForwardRefExoticComponent<AirbnbRatingProps>;
declare const Rating: import("react").FunctionComponent<Omit<RatingProps, keyof import("./config/ThemeProvider").ThemeProps<T>>> | import("react").ForwardRefExoticComponent<RatingProps>;
