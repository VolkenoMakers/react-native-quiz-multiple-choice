...
export { SearchBar };
declare const _default: React.FunctionComponent<Omit<SearchBarBaseProps, keyof import("../config/ThemeProvider").ThemeProps<T>>> | React.ForwardRefExoticComponent<SearchBarBaseProps>;
