...
export { ButtonGroup };
declare const _default: React.FunctionComponent<Omit<ButtonGroupProps, keyof import("../config/ThemeProvider").ThemeProps<T>>> | React.ForwardRefExoticComponent<ButtonGroupProps>;
