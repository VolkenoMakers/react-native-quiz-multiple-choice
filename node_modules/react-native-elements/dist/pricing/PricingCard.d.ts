...
declare const _default: React.FunctionComponent<Omit<PricingCardProps, keyof import("../config/ThemeProvider").ThemeProps<T>>> | React.ForwardRefExoticComponent<PricingCardProps>;
